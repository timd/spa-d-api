...
describe('calculateFees', () => {
  ...
  test('should return a total fee of €227,68 when the number of chilren is 1, personal net income €1000, spouse net income is $1000, joined assets are $0 and open loans are $0', () => {
    // Arrange
    const input = {
      childrenCount: 1,
